...
const TaskForm = ({ initialValues, isEditMode }) => {
  ...
  const formik = useFormik({
    initialValues: initialValues || {
      ...
      owner: "",
      status: "",
      ticketId: "", // Ensure ticketId is part of initialValues
    },
    ...
    onSubmit: async (values) => {
      if (isEditMode) {
        const { _id: taskId, ...updateData } = values;
        await updateTask(taskId, updateData);
      } else {
        await addTask(values); // ticketId is already part of values
      }
    },
